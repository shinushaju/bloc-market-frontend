    ...
    return (
        ...
        >
            <form onSubmit={e => { e.preventDefault(); }}>
                ...
                <button type="button" className="px-5 py-3 my-3" style={props.buttonStyle3} onClick={handleSubmit} disabled={!props.name || !props.description || !props.cover || !props.coverFile || !isAvailable}>{props.buttonLabel}</button>
            </form>
        </Modal>
    )
}
