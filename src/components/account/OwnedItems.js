...
import { Button, Modal, Radio, Space, Avatar, Card } from 'antd';
import { Link } from 'react-router-dom';
import { HeartOutlined } from '@ant-design/icons';
import { getMyAssets, addAssetToCollection } from '../../helpers/asset';
import { getMyCollections } from '../../helpers/collection';

const { Meta } = Card;

const OwnedItems = ({history}) => {
        ...
        <>
            <div className="container-fluid py-2">
                <div className="row">
                    ...
                    {assets.map((asset) =>
                        <div key={asset._id} className="col-sm-4">
                            <Card
                                bordered
                                style={{ width: "100%" }}
                                cover={
