...
const AddItem = ({ history }) => {
    ...
    const handleSubmit = (e) => {
        ...
        Resizer.imageFileResizer(assetFile, 300, 300, 'JPEG', 100, 0, (uri) => {
            createAsset(user._id, { name, description, assetFile: uri, creator: user._id, owner: user._id, collectionId: collection, address: user.address, privateKey: user.privateKey, commission: 0, tokenURI: 'sample' }, user.token)
                .then((res) => {
